    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 overflow-hidden relative">
      ...
      <div className="relative z-10">
        <div className="max-w-7xl mx-auto p-6 md:p-12">
          ...
          {/* Filters */}
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-10 bg-slate-800/50 p-4 rounded-2xl border border-slate-700 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
            {filteredStartups.map((startup, index) => (
              <motion.div
                ...
                className="bg-slate-800/50 rounded-xl overflow-hidden border border-slate-700 hover:border-blue-500/50 transition-all hover:shadow-xl group flex flex-col backdrop-blur-sm"
              >
                <div className="p-6 flex-grow">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="flex items-center text-xs text-slate-500 bg-slate-900/50 px-2 py-1 rounded-md border border-slate-700">
