...
const allTools = [
  ...
  { icon: Database, name: "Data Room", category: "Fundraising", description: "Organize documents for due diligence.", linkPage: Page.GROW, linkSubPage: SubPage.INVESTMENT }, // Linking to Investment generally
    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 p-6 md:p-12">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">The Toolkit</h1>
        ...
        {/* Search and Filter */}
        <div className="mb-10 flex flex-col md:flex-row gap-6 items-center justify-between bg-slate-800/50 p-4 rounded-2xl border border-slate-700">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredTools.map((tool, index) => (
            <motion.div
              ...
              className="bg-slate-800 rounded-xl p-6 border border-slate-700 hover:border-blue-500/50 hover:shadow-lg transition-all group flex flex-col h-full"
            >
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-xs font-medium px-2 py-1 bg-slate-700 rounded-md text-slate-400">
                  {tool.category}
                </span>
              </div>
