    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 overflow-hidden relative">
      ...
      <div className="relative z-10">
        <div className="max-w-7xl mx-auto p-6 md:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            {featuresList.map((feature, index) => (
              <motion.div
                ...
                className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700 hover:border-blue-500/50 transition-colors group backdrop-blur-sm"
              >
          ...
          {/* Deep Dive Section */}
          <div className="bg-slate-800/50 rounded-3xl p-8 md:p-12 border border-slate-700 mb-20 backdrop-blur-sm">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-white">Why Founders Choose Capkit</h2>
                <div className="space-y-6">
                  <div className="flex gap-4">
                    <Zap className="w-6 h-6 text-yellow-400 flex-shrink-0" />
                    <div>
                      <h4 className="font-bold text-lg text-white">AI-Powered Efficiency</h4>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg text-white">Investor Ready</h4>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg text-white">All-in-One Platform</h4>
                      <p className="text-slate-400">Stop switching between spreadsheets, docs, and diverse tools. Manage everything in one place.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center mb-20">
            <h2 className="text-3xl font-bold mb-6 text-white">Ready to experience these features?</h2>
            <Button
              size="lg"
              variant="primary"
