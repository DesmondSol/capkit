...
export const addPageFooter = (doc: any, pageNumber: number, totalPages: number, t: (key: TranslationKey, defaultText?: string) => string) => {
    ...
    // Watermark / Attribution (Right Aligned)
    const watermarkText = "Generated by Capkit.et";
    doc.text(watermarkText, A4_WIDTH_MM - MARGIN_MM, A4_HEIGHT_MM - MARGIN_MM / 2, { align: 'right' });
